...
<div class="container">
    ...
    <div class="row">
       ...
       <div class="col-lg-12"><br /><p class="title_grey_02">VERIFICACIÓN DE CALIDAD EN SITIO <br>
         ...
         <br /><br />
        <div class="row">
           <div class="col-lg-4"> <input type="text" class="form-control" name="cct" placeholder="Escrib el CCT" required maxlength="10" size="10"/></div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-md-pull-6">
            <div class="row">
             ...
             <div class="col-lg-12"><input type="text" class="form-control" disabled></div>
             ...
             <div class="col-lg-12"><input type="text" class="form-control" required></div>
             ...
             <div class="col-lg-12"><input type="text" class="form-control" name="email" placeholder="Correo Electronico" required/></div>
             <div class="col-lg-12"><h4 class="title_red_datos02">Seleccionar el número de aulas</h4></div>
             <div class="col-lg-12">
                   <label class="radio-inline"><input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1" required> 1</label>
                   <label class="radio-inline"><input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="2" required> 2</label>
                   <label class="radio-inline"><input type="radio" name="inlineRadioOptions" id="inlineRadio3" value="3" required> 3</label>
             </div>
          </div>
